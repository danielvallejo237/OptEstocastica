/*
Código más limpio para la tarea 2 que será utilizado en la resolución de la tarea 3
Código de la tarea 3 con tal de encontrar mejores soluciones candidatas usando alguna herramienta
del tipo branch and bound o programación dinámica
@Author: Daniel Vallejo Aldana / Centro de Investigación en Matemáticas
*/
